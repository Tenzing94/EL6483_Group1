...
void setup() {
  ...
  // initialize lcd display with the I2C addr 0x3C (for the 128x32)
...
void sampleData()
{
  ...
  // display current freq and mag
  display.clearDisplay();
  display.setTextSize(2);
  display.setTextColor(WHITE);
  display.setCursor(0,0);
  display.println("F: "+String(frequency_bin_index*250/1000)+" KHz");
  display.println("M: "+String(vReal[frequency_bin_index]*10));
  display.display();
}
/////////////////////////////////////////////////////////////////////////////////////////
